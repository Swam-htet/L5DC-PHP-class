...
<h1>Privacy Policy for GWSC</h1>

<p>At localhost:3001, accessible from localhost:3001, one of our main priorities is the privacy of our visitors. This
...
<p>localhost:3001 follows a standard procedure of using log files. These files log visitors when they visit websites.
...
<p>Like any other website, localhost:3001 uses "cookies". These cookies are used to store information including
...
<p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our
...
<P>You may consult this list to find the Privacy Policy for each of the advertising partners of localhost:3001.</p>
...
<p>Note that localhost:3001 has no access to or control over these cookies that are used by third-party advertisers.</p>

<h2>Third Party Privacy Policies</h2>

<p>localhost:3001's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
...
<p>localhost:3001 does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
