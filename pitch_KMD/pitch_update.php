...
?>
    ...
    <form action="pitch_update_process.php" method="post">
        ...
        <div>
            <label for="pname">Camping Name : </label>
            <?php
            echo "<input type='text' name='pname' value='$data->pname'>"
            ?>
        ...
        <div>
            ...
            <?php
            echo "<input type='text' name='location' value='$data->location'>"
            ?>
        </div>
        ...
        <div>
            ...
            <?php
            echo "<input type='text' name='address' value='$data->address'>"
            ?>
        </div>
        ...
        <div>
            ...
            <?php
            echo "<input type='text' name='general' value='$data->general'>"
            ?>
        </div>
        <div>
